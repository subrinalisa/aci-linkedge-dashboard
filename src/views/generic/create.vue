  ...
  <MainLayout>
    <div class="bg-white p-3 rounded-md">
      <div class="flex justify-between items-center">
        <div class="mb-3">
          <h6 class="font-medium">Create New Generic</h6>
        </div>
        <div class="mb-3">
      ...
      <form @submit.prevent="submitForm()">
        <div class="lg:grid grid-cols-3 gap-4 items-center">
          ...
          <input id="category" type="text" placeholder="Enter here . . ." v-model="form.category"
...
const submitForm = async () => {
  if (validateForm()) {
    ...
    try {
      ...
      const response = await apiClientMultiple.post(`/generics`, form.value);
