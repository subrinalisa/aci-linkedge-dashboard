...
const { getSalesDetails, getSaleSuspended, getSaleVerified } = verifyStore;
    ...
    <div class="grid grid-cols-3 gap-4" v-else>
        ...
        <div class="overflow-x-auto">
          <table class="purchase-table">
            ...
            <tbody class="table-body">
              <tr
                v-for="(product, index) in allData?.sale_products"
                :key="index"
              >
                <td>{{ index + 1 }}</td>
      ...
      <div class="right-side">
        ...
        <a-popconfirm
          ...
          ok-text="Yes"
          cancel-text="No"
          @confirm="getSaleSuspended(id, $router)"
        >
          <button
        ...
        <button
          ...
          type="button"
          @click="getSaleVerified(id, $router, verifyData)"
        >
          Verified
        </button>
